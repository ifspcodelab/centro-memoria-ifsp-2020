...
urlpatterns = [
    ...
    path('pesquisa/?categoria=<str:categoria>&fundo_colecao=<str:fundo_colecao>&autor=<str:autor>&titulo=<str:titulo>&data=<str:data>&periodo_inicio=<str:periodo_inicio>&periodo_fim=<str:periodo_fim>&/', views.acervo_pesquisa_avancada, name='pesquisa_avancada'),
